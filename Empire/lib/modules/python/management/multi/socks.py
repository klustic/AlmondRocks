...
class Module:
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        module_source_file = os.path.join(self.mainMenu.installPath, 'data/module_source/python/management/socks-src.py')
        try:
        ...
        try:
            module = module_template.substitute(TUNNEL_ADDR=self.options['server']['Value'])
